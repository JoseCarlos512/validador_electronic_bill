...
class Signature {
    public function signature_xml($flg_firma, $ruta, $ruta_firma, $pass_firma) {        
        ...
        $ruta = "C:/xampp/htdocs/validador_electronic_bill/facturacion/xml/20607599727-01-F001-14.XML";
        $ruta_firma = "C:/xampp/htdocs/validador_electronic_bill/facturacion/certificado_prueba.pfx";
